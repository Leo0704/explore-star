 ...
 */
export async function buildKnowledgeIndex(businessDir, embeddingProvider, dbPath = './data/vectors.db') {
    ...
    `);
        ...
        // 写入新数据
        const insert = db.prepare('INSERT INTO knowledge_vectors (path, content, embedding) VALUES (?, ?, ?)');
