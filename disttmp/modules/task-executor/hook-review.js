 ...
 */
export async function reviewHook(task, reviewConfig = false) {
    if (!reviewConfig) {
 ...
 * 检查任务是否需要审核
 */
export function needsReview(task, reviewConfig) {
 ...
 * 生成审核备注（用于多维表展示）
 */
export function generateReviewNote(task) {
    return [
        `客户：${task.nickname}`,
...
//# sourceMappingURL=hook-review.js.map