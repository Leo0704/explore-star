...
export type LeadStatus = '新发现' | '已关注' | '已互动' | '已加好友' | '已加微' | '已预约' | '已成交' | '已流失' | '沉默' | '已再激活';
...
export type TaskAction = 'like_and_follow' | 'comment_reply' | 'friend_request' | 'dm' | 'send_material';
export type TaskResult = 'executed_with_response' | 'executed_no_response' | 'rejected' | 'failed_risk' | 'failed_network' | 'skipped';
