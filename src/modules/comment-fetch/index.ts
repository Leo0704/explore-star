 ...
 */
export function normalizeSearchResults(videos: Video[], keyword: string): Comment[] {
 ...
 */
export function normalizeUserVideos(videos: UserVideo[], secUid: string): Comment[] {
...
export function normalize(videos: Video[], keyword: string): Comment[];
export function normalize(videos: UserVideo[], keyword: string): Comment[];
export function normalize(
  videos: Video[] | UserVideo[],
  keyword: string,
): Comment[] {
  if (isUserVideos(videos)) {
    return deduplicateComments(normalizeUserVideos(videos, keyword));
  }
  return deduplicateComments(normalizeSearchResults(videos as Video[], keyword));
}

function isUserVideos(v: Video[] | UserVideo[]): v is UserVideo[] {
